...
if (isset($_REQUEST['payid_remove']))
 {
	$delete_sql="DELETE From payment where payid='".$_REQUEST['payid_remove']."'";
	$del_result=mysqli_query($conn,$delete_sql);

?>
<script type="text/javascript">window.location.href="manage_payment.php"</script>
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Gym Admin Panel - Manage Payment</title>
<!-- CSS Files -->
				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="manage_trainers.php"><i class="fa fa-inr"></i> Manage Payment</a>
							</li>
						</ul>
					</div>
					<div class="row">
						<div class="col-md-12">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title"><i class="fa fa-inr"></i> Manage Payment</div>
								</div>
								<div class="card-body">
		...
		<tbody>
			...
			while ($row = mysqli_fetch_array($result)) {
				...
				<tr>
					...
					<td align="center">
						<a href="manage_payment.php?payid_remove=<?php echo $row ['payid'] ?>">Delete
						</a>

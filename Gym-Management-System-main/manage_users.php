...
if (isset($_REQUEST['mid_remove']))
 {
	$delete_sql="DELETE From membertbl where mid='".$_REQUEST['mid_remove']."'";
	$del_result=mysqli_query($conn,$delete_sql);

?>
<script type="text/javascript">window.location.href="manage_users.php"</script>
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Gym Admin Panel - Manage User</title>
				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#"><i class="fa fa-users"></i> Manage Members</a>
							</li>
						</ul>
					</div>
					<div class="row">
						<div class="col-md-12">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title"><i class="fa fa-users"></i> Manage Members </div>
								</div>
								<div class="card-body">
...
<?php
			while ($row = mysqli_fetch_array($result)) {
				...
				<tr>
					...
					<td>
					<a href="manage_users.php?mid_remove=<?php echo $row ['mid'] ?>" 

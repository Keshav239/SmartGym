...
$sql="SELECT * from trainertbl";

$result=mysqli_query($conn,$sql);
if (isset($_REQUEST['tid_remove']))
 {
	$delete_sql="DELETE From trainer_tbl where tid='".$_REQUEST['tid_remove']."'";
	$del_result=mysqli_query($conn,$delete_sql);

?>
<script type="text/javascript">window.location.href="manage_trainers.php"</script>
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Gym Admin Panel - Manage Trainer</title>
	<!-- CSS Files -->
				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="manage_trainers.php"><i class="fa fa-graduation-cap"></i> Manage Trainers</a>
							</li>
						</ul>
					</div>
					<div class="row">
						<div class="col-md-12">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title"><i class="fa fa-graduation-cap"></i> Manage Trainers </div>
								</div>
								<div class="card-body">
									<!--<a href="user_form.html" class="btn btn-success btn-sm"> + Add Users</a> -->
		...
		<tbody>
			...
			while ($row = mysqli_fetch_array($result)) {
				...
				<tr>
					...
					<td align="center">
						<a href="manage_trainers.php?tid_remove=<?php echo $row ['tid'] ?>">Delete
						</a>
